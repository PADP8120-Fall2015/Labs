...
Load the NYC School Voucher data set that we have previously used:
...
19. Go back to the school voucher dataset, and perform a chi-square test to see if it looks the like vouchers were truly randomized in terms of how many Hispanic versus non-Hispanic students recieved a voucher (the `Treatment` variable)

20. Conduct a similar analysis, but this time see if the vouchers appear to be randomized by sex (`Female` variable). 
