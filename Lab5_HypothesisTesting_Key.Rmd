...
The second input is the rate parameter, which effects the shape of the exponential curve (it is called the "rate" because it is the decay rate for the function). As the rate parameter increases, the curve drops more steeply (i.e, things decay faster), and as the rate parameter decreases, the curve decents more slowly. 
